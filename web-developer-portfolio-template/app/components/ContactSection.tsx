    ...
    <section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
          <a
            href="mailto:shiv.baral500@gmail.com?subject=Data%20Engineering%20Inquiry"
        ...
        <div className="flex justify-center gap-6">
          <a
            href="https://github.com/shiva500"
            target="_blank"
        ...
        {/* Bonus: quick capability chips (optional) */}
        <div className="mt-8 flex flex-wrap justify-center gap-2 text-xs sm:text-sm text-gray-400">
          {['Databricks', 'Delta Lake', 'Apache Spark', 'Kafka', 'Airflow', 'dbt', 'BigQuery', 'Terraform', 'Unity Catalog'].map((chip) => (
            <span key={chip} className="px-3 py-1 rounded-full bg-[#1A1F2B] border border-[#2D333B]">
              {chip}
            </span>
          ))}
        </div>
