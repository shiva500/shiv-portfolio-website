...
// 								<h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-400">Data Engineer</h2>
// 								<span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
// 							</div>
// 							<p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
// 								Building scalable, high‑throughput data pipelines and architectures to power analytics and AI.
// 							</p>
// 						</div>

// 						{/* Tech Stack Pills */}
// 						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
// 							{['Python', 'SQL', 'PySpark', 'Apache Airflow', 'Cloud Platforms (AWS/GCP)'].map((tech) => (
// 								<span
// 									key={tech}
...
export const HeroSection = () => {
  ...
  const floaters = [
    { icon: '🛡️', delay: '0s', position: 'top-20 left-1/5' },      // governance
    { icon: '⚡',  delay: '1.2s', position: 'top-40 right-1/4' },   // streaming
    { icon: '☁️',  delay: '2.2s', position: 'bottom-28 left-1/3' }, // cloud
    { icon: '🗄️', delay: '3s', position: 'bottom-20 right-1/5' },  // storage/warehouse
  ];
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Animated Background Grid */}
      <div className="absolute inset-0 grid-background opacity-20">
        <div className="grid-overlay animate-pulse-slow" />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {floaters.map((f, i) => (
          <div
            key={i}
            className={`absolute ${f.position} animate-float opacity-50`}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
            <div className="flex flex-col items-center gap-4">
              <div className="flex items-center gap-3">
                <span className="h-[1px] w-8 sm:w-12 bg-blue-500" />
                <h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-400">
                  Data Engineer • Lakehouse & Streaming
                </h2>
                <span className="h-[1px] w-8 sm:w-12 bg-blue-500" />
              </div>
              <p className="text-base sm:text-lg text-gray-400 max-w-3xl px-4 sm:px-0">
                I design GCP-first, multi-cloud data platforms—batch and streaming—using
                <span className="mx-1 font-semibold text-gray-200">Databricks</span>,
                <span className="mx-1 font-semibold text-gray-200">Apache Spark</span>, and
                <span className="mx-1 font-semibold text-gray-200">Delta Lake</span>.
                Governed with Unity Catalog, automated with Airflow/Composer and dbt, and optimized for BI & ML.
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-8 sm:mt-12 px-4 sm:px-0">
            <a href="#work" className="group relative inline-flex items-center justify-center">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full blur opacity-75 group-hover:opacity-100 transition" />
              <span className="relative px-6 sm:px-8 py-3 bg-[#161B22] rounded-full inline-flex items-center justify-center w-full sm:w-auto">
                View Projects
                <svg
